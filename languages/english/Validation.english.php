...
$txt['_validate_alpha_dash'] = 'The %1$s field may only contain alpha characters &amp; dashes';
$txt['_validate_numeric'] = 'The %1$s field may only contain numeric characters';
$txt['_validate_integer'] = 'The %1$s field may only contain a numeric value';
$txt['_validate_boolean'] = 'The %1$s field may only contain a true or false value';
$txt['_validate_float'] = 'The %1$s field may only contain a float value';
$txt['_validate_valid_url'] = 'The %1$s field is required to be a valid URL';
$txt['_validate_url_exists'] = 'The URL %1$s does not exist';
$txt['_validate_valid_ip'] = 'The %1$s field needs to contain a valid IP address';
