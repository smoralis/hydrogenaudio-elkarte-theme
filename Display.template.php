...
function template_messages()
{
	...
	while ($message = $controller->{$context['get_message'][1]}())
	{
		...
		echo '
				<div class="post_wrapper ', $message['classes'], $message['approved'] ? ($message['alternate'] == 0 ? ' windowbg' : ' windowbg2') : ' approvebg', $message['id'] == $context['first_message'] ? ' firstpost' : '', '">', $message['id'] != $context['first_message'] ? '
